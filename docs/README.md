...
If you're not using Homebrew on Linux, download the prebuilt binary:
...
This works on most distributions (Debian/Ubuntu, Fedora/RHEL, Arch, Alpine, etc.) since the binary is statically linked.
...
### macOS (manual install, no Homebrew)
